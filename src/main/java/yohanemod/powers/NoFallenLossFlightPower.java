...
public class NoFallenLossFlightPower extends FlightPower {
    public static final String POWER_ID = "Yohane:NoFallenFlightPlayer";
    ...
    public NoFallenLossFlightPower (AbstractCreature owner, int amount)
    {
        super(owner, amount);
        name = NAME;
        ID = POWER_ID;
